...
export default function LoginForm() {
  ...
  return (
    <div className="w-full bg-[#09090b] border border-white/10 rounded-2xl p-8">
      <p className="text-center text-sm text-zinc-500 mb-6">Accedi al tuo account</p>
      <button
      ...
      >
        <GoogleIcon />
        {isLoading ? 'Reindirizzamento...' : 'Accedi con Google'}
      </button>
    </div>
  );
}
